...
public class Super_calculator implements ActionListener{
     String s="",s1;
     double d1,d2;
    ...
    public static void main(String[] args) {
        ...
        new Super_calculator().initialize();
///				window.frame.setVisible(true);
    ...
    private void initialize() {
        ...
        frame.setBounds(100, 100, 456, 717);
...
//        else if(command.equals("OFF")) System.exit(0);//off键 关闭应用程序 无OFF按键
                ...
                &&!command.equals("=")&&!command.equals("n!")
                &&!command.equals("log")&&!command.equals("sqrt")
                &&!command.equals("\u03C0")&&!command.equals("cos")
                &&!command.equals("sin")&&!command.equals("tan")
                &&!command.equals("1/x")&&!command.equals("%")
                &&!command.equals("x^2")&&!command.equals("x^3"))//判断输入是否为数字
        {
            ...
            try
            {
                ...
                else if(s.equals("n!"))d1 = d2/d1;//n!运算
                else if(s.equals("log"))d1 = Math.log(d2)/Math.log(d1);//log运算
                else if(s.equals("sqrt"))d1 = Math.sqrt(d1);//sqrt运算
                else if(s.equals("sin"))d1 = Math.sin(d2);//sin运算
                else if(s.equals("\u03C0"))d1 = d2/d1;//π运算
                else if(s.equals("cos"))d1 = d2/d1;//cos运算
                else if(s.equals("1/x"))d1 = d2/d1;//1/x运算
                else if(s.equals("tan"))d1 = d2/d1;//tan运算
                else if(s.equals("%"))d1 = d2/d1;//%运算
                else if(s.equals("x^2"))d1 = d1*d1;//x^2运算
                else if(s.equals("x^3"))d1 = d2*d2*d2;//x^3运算
            }
            catch(Exception ex)
            {
        ...
        else if(!command.equals("=")) //判断输入是否中缀表达式
        {
            s = command;
            s1 = null;
            d2 = d1;
